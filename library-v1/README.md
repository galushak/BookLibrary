...
- TBR, In Progress, Finished, and DNF shelves, with quick status changes on every book
...
- Optional full-series discovery: add every missing volume as TBR using the same selected book formats and ownership state
...
- Search, filtering, sorting, quick status changes, and overview counts
